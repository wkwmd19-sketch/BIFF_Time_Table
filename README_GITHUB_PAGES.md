...
- BIFF 2026 **10월 7일~11일, 총 459개 상영 회차** 포함
- 10월 7일 상영코드/GV/러닝타임 추가
- 기존 브라우저의 10/8~10/11 선택 일정은 같은 localStorage 키를 사용하므로 유지됩니다.

## 좌석수 표시 (2026-09-17 기준)

영화 블록, 내 시간표, Excel 내보내기에 상영관 좌석수를 표시합니다.
좌석수는 공개된 시설/상영관 자료 기준이며, BIFF 운영상 판매 제한석·초청석·휠체어석 운영 또는 멀티플렉스 리뉴얼에 따라 실제 예매 가능한 좌석수와 다를 수 있습니다.
